# CMS Devs AI Playbook

## Building WordPress Sites on the Offshorly Boilerplate with AI Assistance

> **Audience:** CMS Developers building client sites on the Offshorly WP Boilerplate (Bedrock + Timber + ACF Pro + UIkit 3) using Claude Code's AI assistance. For the design-side companion to this workflow, see the [DDT AI Playbook](DDT-AI_playbook.md).
>
